...
# W. B. Yates 17/06/21 - for Python 3 compatability the following changes have been made:
# replaced xrange with range, and 
# on line 166, replace 'decorated.sort()'  with 'sorted(decorated, key=lambda n: n[0])'
# These modifications have been tested OK
