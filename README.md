# NSGA2 - A Multiobjective Evolutionary Algorithm
...
This version implements constraint handling.

Python MOEA tested on Python versions 3.8 to 3.13.

C++ MOEA depends solely on STL, tested on c++20.
